...
def main(args):
    ...
    with h5py.File("sampleData" + str(args.tag) + ".h5", "w") as hf:
        hf.create_dataset(str(args.tag)+"/Sample Data", data=trainingFullData)
